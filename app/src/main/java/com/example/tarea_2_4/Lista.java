...
public class Lista extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ListaAdaptada(this,R.layout.item_row, mLista);
    ...
    private void cargarDatos(){
        ...
        while (cursor.moveToNext()){
            ...
            mAdapter = new ListaAdaptada(this,R.layout.id_firma, mLista);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        enviar= mLista.get(position).getFirma();
